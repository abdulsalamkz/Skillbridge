...
?>
<section class="py-24">
    <div class="container mx-auto px-4 lg:px-32 gap-10 grid grid-cols-1 lg:grid-cols-2 items-center">
        <div class="mb-10 lg:mb-0 lg:mt-10 mt-0">
            <div class="mb-10">
        ...
        <div class="w-full mx-auto lg:mx-0 bg-white-99  p-8 rounded-lg">
            <h2 class="text-5xl	 font-semibold text-center mb-6">Sign Up</h2>
            ...
            <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="absolute inset-y-0 right-3 flex items-center">
                            <i class="fas fa-eye text-gray-400 mt-2"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="remember" class="ml-2 text-sm text-gray-900">I agree with <a href="#" class="underline">Terms of Use </a>and <a href="#" class="underline"> Privacy Policy</a></label>
                </div>

                <div>
                    <button type="submit" class="w-full bg-orange-50 text-white-99 py-2 px-4 rounded-md">Sign Up</button>
                </div>
                ...
                <div>
                    <button type="button" class="w-full flex items-center justify-center bg-white-97 border-white-95 mt-4 text-gray-700 py-2 px-4  border-gray-300 rounded-md shadow-sm hover:bg-gray-50 transition">
                ...
                <div class="mt-4 text-sm text-center ">
                    <p>Already have an account?<a href="#" class="text-orange-500  underline">Login</a></p>
                </div>
            </form>
        </div>
    </div>
